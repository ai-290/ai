...
cmd(
    ...
    async (conn, mek, m, { args, q, reply }) => {
        try {
            ...
            const apiUrl = "https://api.purrbot.site/v2/img/sfw/comfy/gif";
            let res = await axios.get(apiUrl);
...
cmd(
    ...
    async (conn, mek, m, { args, q, reply }) => {
        try {
            ...
            const apiUrl = "https://api.purrbot.site/v2/img/sfw/eevee/gif";
            let res = await axios.get(apiUrl);
...
cmd(
    ...
    async (conn, mek, m, { args, q, reply }) => {
        try {
            ...
            const apiUrl = "https://api.purrbot.site/v2/img/sfw/fluff/gif";
            let res = await axios.get(apiUrl);
...
cmd(
    ...
    async (conn, mek, m, { args, q, reply }) => {
        try {
            ...
            const apiUrl = "https://api.purrbot.site/v2/img/sfw/lay/gif";
            let res = await axios.get(apiUrl);
...
cmd(
    ...
    async (conn, mek, m, { args, q, reply }) => {
        try {
            ...
            const apiUrl = "https://api.purrbot.site/v2/img/sfw/tail/gif";
            let res = await axios.get(apiUrl);
